function valetonOutput=getRespNoPlots(varargin)
% function valetonOutput=getRespNoPlots(varargin)
% A Frankensteinian conglomeration of the s_sceneCheckerboardTest and
% getOSRespCheckerboard functions that runs without producing any plots or
% graphs. See the other two functions for more detail on the calculations.
%
